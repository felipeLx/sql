...
# Functions are like macros in Excel: a set of instructions that can be run by 
# calling the function's name. Sometimes you're required to enter parameters.
...
# the function that you want to use, you can press the tab key to insert it.
        # Try typing out log() on the left of the hashtag on this line.
